...
const menuStructure = {
  ...
  // Dalam Drawer.tsx, pastikan handleItemPress seperti ini:
const handleItemPress = (screen: string, params?: any, itemId?: string) => {
  ...
  if (screen === 'Home') {
    ...
    nav.navigate('Bookmarks');
  } else if (params?.directToArticles) {
    // Navigasi ke Category stack dengan directToArticles
    nav.navigate('Category', {
      categoryId: params.categoryId,
      categoryName: params.categoryName,
      directToArticles: true
    });
  } else {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.drawer}>
        ...
        // Tambahkan menu Bookmarks di drawer (sebelum Settings & Help)
<TouchableOpacity
  style={[styles.navItem, activeItem === 'bookmarks' && styles.navItemActive]}
  onPress={() => handleItemPress('Bookmarks', null, 'bookmarks')}
  accessibilityRole="button"
  accessibilityLabel="Buka bookmark artikel"
>
  <View style={styles.navIconContainer}>
    <Text style={[styles.navIcon, activeItem === 'bookmarks' && styles.navIconActive]}>🔖</Text>
  </View>
  <Text style={[styles.navLabel, activeItem === 'bookmarks' && styles.navLabelActive]}>
    Bookmark Saya
  </Text>
  {activeItem === 'bookmarks' && <View style={styles.activeIndicator} />}
</TouchableOpacity>
